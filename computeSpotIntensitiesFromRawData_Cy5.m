function [valuesCy3, bkg] = computeSpotIntensitiesFromRawData_Cy5(location,overlap,rotAngleTile,posColRange,imRange,weights,rotAngle,roi,offsetIm,mask,bkgMask)
...
parfor k=1:numel(imRange)
    ...
    if computeBkg
        bkg{k} = computeSpotIntensities_Cy5(mergedIm,bkgMask);
    end
end
