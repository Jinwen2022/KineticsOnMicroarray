function [fluoValues, bkgValues, mask,bkgMask] = processArraysLight2(dirFluo,dirOffset,parameters)
...
%   bkgMask - labelled image of local backgrounds of microarray spots
%   lablled in the mask variable
%
